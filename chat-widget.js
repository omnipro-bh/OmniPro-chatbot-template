...
toggleButton.innerHTML = `
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
    <path d="M12 2C6.48 2 2 6.03 2 11c0 1.96.8 3.76 2.13 5.18L2 22l5.53-2.31C8.49 20.23 10.19 21 12 21c5.52 0 10-4.03 10-9s-4.48-9-10-9zm0 16c-1.54 0-3.04-.5-4.23-1.41l-.3-.23-3.11 1.3.72-3.02-.23-.3C4.5 13.04 4 11.54 4 10c0-4.08 3.58-7 8-7s8 2.92 8 7-3.58 7-8 7z"/>
  </svg>`;
